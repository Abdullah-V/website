export default {
    ...
    meta: [
      ...
      { name: 'keywords', content: 'Abdullah,Veliyev,Abdullah Veliyev,Personal,website,Personal website,dotslashroot,2005'},
      ...
      { property:'twitter:description', content: 'Personal website of Abdullah V.' },
